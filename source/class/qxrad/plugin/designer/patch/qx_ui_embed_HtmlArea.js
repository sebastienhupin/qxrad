...
qx.Class.define("qxrad.plugin.designer.patch.qx_ui_embed_HtmlArea",
{
  ...
  members :
  {
    ...
    _createObject : function()
    {
      ...
      var object = new clazz("Your content here ...", null, "blank.html");
    ...
    {
      var template = new qxrad.plugin.designer.template.build.HtmlArea();
      var code = [];
